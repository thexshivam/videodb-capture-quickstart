...
cd videodb-capture-quickstart/examples/fact-detector
```
...
- **Screen Recording** — must be granted manually:
  ...
  2. Click **+**, press **Cmd+Shift+G**, and paste:
     ```
     examples/fact-detector/node_modules/electron/dist/Electron.app
     ```
...
cd examples/fact-detector/backend
